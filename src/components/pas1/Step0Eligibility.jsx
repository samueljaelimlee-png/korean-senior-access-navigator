...
import { Info, CheckCircle, AlertCircle, Wand2, ArrowRight } from 'lucide-react';
...
const QUESTIONS = [
  ...
  { key: 'homeowner', text: '2025년 10월 1일 기준 NJ 주택을 소유 또는 임차하셨나요?', sub: '소유자·임차인 모두 해당됩니다.' },
  { key: 'incomeLow', text: '2025년 연간 총소득이 $500,000 미만이신가요?', sub: '부부 합산 기준' },
  { key: 'propTax', text: '해당 주택에 재산세(Property Tax)가 부과되고 있나요?', sub: '100% 장애 재향군인 재산세 면제자는 해당 없음' },
];
