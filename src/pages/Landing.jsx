...
const SECTIONS = [
  ...
  },
  {
    ...
    badge: '마감 Nov 2, 2026',
    badgeColor: 'bg-red-100 text-red-700',
    title: 'NJ ANCHOR Benefit (Under 65)',
    titleEn: 'ANCHOR 혜택 신청 (65세 미만)',
    subtitle: 'ANC-1 · Homeowners & Renters Under 65',
    desc: '65세 미만이거나 장애급여를 받지 않는 분을 위한 ANCHOR 재산세 혜택 신청서입니다. 주택 소유자와 임차인 모두 해당하며, 단계별 한국어 안내로 쉽게 작성할 수 있습니다.',
    descEn: 'ANCHOR property tax benefit application for homeowners and renters under 65 who do not receive disability benefits. Step-by-step Korean guidance.',
    highlights: ['주택 소유자 (소득 $250k 이하)', '임차인 (소득 $150k 이하)', '한글 입력 · 인쇄 지원'],
